<template>
  ...
  <div>
    <page-model>
      ...
      <template slot="tableInner">
        <el-table :data="tableData" border>
          <el-table-column prop='name1' label='协议编号' min-width="80"></el-table-column>
          <el-table-column prop='name2' label='代理商编号' min-width="80"></el-table-column>
          <el-table-column prop='name3' label='商户编号' min-width="80"></el-table-column>
          <el-table-column prop='name4' label='产品编号' min-width="80"></el-table-column>
          <el-table-column prop='name5' label='代理商佣金比例' min-width="80"></el-table-column>
          <el-table-column prop='name6' label='执行主机' min-width="80"></el-table-column>
    ...
    <!-- 协议新增 -->
    <el-dialog title="协议新增" :visible.sync="addDisplay" width="600px">
      <el-form ref="alertAddModelForm" :model="addModelData" class="alert-model-form" label-width="120px" :show-message="false">
        ...
        <el-form-item prop="name5" label="商户编号" required>
          <el-input v-model="addModelData.name5"></el-input>
        </el-form-item>
        <el-form-item prop="name8" label="商品编号" required>
          <el-input v-model="addModelData.name8"></el-input>
        </el-form-item>
        <el-form-item prop="name9" label="单笔交易限额" required>
