<template>
  ...
  <div>
    <page-model>
      <template slot="controlQueryOps">
        <el-form :model="examine" label-width="86px" :inline="true" ref="controlQueryForm">
          <el-form-item label="产品编号" prop="name1">
    ...
    <!-- 支付产品新增 -->
    <el-dialog title="支付产品新增" :visible.sync="addDisplay" width="600px">
      <el-form ref="alertAddModelForm" :model="addModelData" class="alert-model-form" label-width="130px" :show-message="false">
        <el-form-item label="产品编号" prop="name1" required>
          <el-input v-model="addModelData.name1"></el-input>
        </el-form-item>
        <el-form-item label="产品名称" prop="name2" required>
          <el-input v-model="addModelData.name2"></el-input>
        </el-form-item>
        <el-form-item label="产品说明" prop="name3" required>
          <el-input v-model="addModelData.name3"></el-input>
        </el-form-item>
        <el-form-item label="标准费率" prop="name4" required>
          <el-input v-model="addModelData.name4" placeholder="请填写小数"></el-input>
        </el-form-item>
      </el-form>
