  ...
  <div>
    <page-model>
      <template slot="controlQueryOps">
        <el-form :model="examine" label-width="86px" :inline="true" ref="controlQueryForm">
          <el-form-item label="费用代码" prop="name1">
            <el-input v-model="examine.name1"></el-input>
          </el-form-item>
          <el-form-item label="费用名称" prop="name2">
      ...
      <template slot="tableInner">
        <el-table :data="tableData" border>
          <el-table-column prop='name1' label='费用代码' width="100"></el-table-column>
          <el-table-column prop='name2' label='费用名称' width="100"></el-table-column>
          <el-table-column prop='name3' label='描述' min-width="100"></el-table-column>
    ...
    <el-dialog title="新增费用" :visible.sync="addDisplay" width="600px">
      <el-form ref="alertAddModelForm" :model="addModelData" class="alert-model-form" label-width="120px" :show-message="false">
        <el-form-item prop="name1" label="费用代码" required>
          <el-input v-model="addModelData.name1"></el-input>
        </el-form-item>
        <el-form-item prop="name2" label="费用名称" required>
          <el-input v-model="addModelData.name1"></el-input>
        </el-form-item>
        <el-form-item prop="name8" label="描述">
    ...
    <el-dialog title="任务修改" :visible.sync="editorDisplay" width="600px">
      <el-form :model="editorModelData" class="alert-model-form" label-width="120px" :show-message="false">
        ...
        <el-form-item prop="name3" label="描述" required>
