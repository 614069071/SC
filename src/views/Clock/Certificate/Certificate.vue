  ...
  <div>
    <page-model>
      <template slot="controlQueryOps">
        <el-form :model="examine" label-width="100px" :inline="true" ref="controlQueryForm">
          <el-form-item label="证件编号" prop="name1">
            <el-input v-model="examine.name1"></el-input>
          </el-form-item>
          <el-form-item label="证件类型" prop="name2">
      ...
      <template slot="tableInner">
        <el-table :data="tableData" border>
          <el-table-column prop='name1' label='证件代码' width="200"></el-table-column>
          <el-table-column prop='name2' label='证件类型' min-width="100"></el-table-column>
    ...
    <el-dialog title="新增费用" :visible.sync="addDisplay" width="600px">
      <el-form ref="alertAddModelForm" :model="addModelData" class="alert-model-form" label-width="120px" :show-message="false">
        <el-form-item prop="name1" label="证件代码" required>
          <el-input v-model="addModelData.name1"></el-input>
        </el-form-item>
        <el-form-item prop="name2" label="证件类型" required>
